...
export default function Card({ company, logo, place, children }: Props) {
  return (
    <div className="bg-[#1d202199] backdrop-blur-lg rounded-lg p-2 pb-6 shadow-[1px_3px_6px_rgb(0,0,0,0.3)]">
