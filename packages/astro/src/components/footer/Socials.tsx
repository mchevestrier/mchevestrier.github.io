export default function Socials() {
  return (
    <div className="pt-4 flex justify-center gap-5">
      <a
        href="https://www.linkedin.com/in/martin-chevestrier/"
        title="LinkedIn"
        target="_blank"
        className="hover:text-[#2956c9] focus:text-[#2956c9]"
      >
      ...
      <a
        href="https://github.com/mchevestrier"
        rel="nofollow"
        target="_blank"
        title="GitHub"
        className="hover:text-[#807e7e] focus:text-[#807e7e]"
      >
      ...
      <a
        href="https://mastodon.social/@mchevestrier"
        rel="me"
        target="_blank"
        title="Mastodon"
        className="hover:text-[#6364ff] focus:text-[#6364ff]"
      >
      ...
      <a
        href="https://keybase.io/mchevestrier"
        rel="nofollow"
        target="_blank"
        title="Keybase"
        className="hover:text-[#ff6f21] focus:text-[#ff6f21]"
      >
      ...
      <a
        href="/keys/Martin-Chevestrier_0xB4B7F519_public.asc"
        rel="nofollow"
        target="_blank"
        title="PGP"
        className="hover:text-[#3399db] focus:text-[#3399db]"
      >
